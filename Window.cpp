...
Window::Window(GLint windowWidth, GLint windowHeight)
{
	...
	muevex = 0.0f;      // Traslación del coche
	rotay = 0.0f;       // Giro del coche (opcional)
	rotallanta = 0.0f;  // Rotación en Z de llantas
	cofre = 0.0f;       // Rotación en Z del cofre

	// --- INICIALIZACIÓN PRÁCTICA 6 (OCTAEDRO) ---
	rotacion1 = 0.0f;   // Rotación X (Tecla B)
	rotacion2 = 0.0f;   // Rotación Y (Tecla N)
	rotacion3 = 0.0f;   // Rotación Z (Tecla M)
...
int Window::Initialise()
{
	...
	// Título actualizado para la Práctica 6
