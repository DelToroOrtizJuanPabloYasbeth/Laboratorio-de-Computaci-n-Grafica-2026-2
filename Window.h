...
public:
	...
	int getLuzPrendida() { return luzPrendida; }
	int getColorCiclo() { return colorCiclo; }
	int getDireccionHeli() { return direccionHeli; }

	// Lógica de reinicio con tecla R
	bool getReiniciarAnimacion() { return reiniciarAnimacion; }
	void apagarReinicio() { reiniciarAnimacion = false; }
	
	//Lógica presión con tecla T
